...
function GYWBT_ADULT_CONFIG(lang) {
  ...
  return {
    ...
    journeyMobile: {
      clip: '/adult/assets/vid/journey-m.mp4?v=10',
    ...
    sections: [
      ...
      { id:'glowup', label:'The Crash',
        still:'/adult/assets/glowup.webp?v=9', poster:'/adult/assets/glowup-poster.webp?v=7', posterMobile:'/adult/assets/glowup-poster-m.webp?v=9',
        clip:'/adult/assets/vid/glowup.mp4?v=7', clipMobile:'/adult/assets/vid/glowup-m.mp4?v=9',
      ...
      { id:'photo', label:'Say Cheese',
        still:'/adult/assets/photo.webp?v=10', poster:'/adult/assets/photo-poster.webp?v=7', posterMobile:'/adult/assets/photo-poster-m.webp?v=10',
        clip:'/adult/assets/vid/photo.mp4?v=7', clipMobile:'/adult/assets/vid/photo-m.mp4?v=10',
