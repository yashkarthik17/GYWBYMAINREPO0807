...
function GYWBT_ADULT_CONFIG() {
  return {
    ...
    journeyMobile: {
      clip: '/adult/assets/vid/journey-m.mp4?v=7',
    ...
    sections: [
      ...
      { id:'glowup', label:'The Crash',
        still:'/adult/assets/glowup.webp?v=7', poster:'/adult/assets/glowup-poster.webp?v=6', posterMobile:'/adult/assets/glowup-poster-m.webp?v=7',
        clip:'/adult/assets/vid/glowup.mp4?v=6', clipMobile:'/adult/assets/vid/glowup-m.mp4?v=7',
        scroll:1.6, linger:0.35, rate:1.25,
      ...
      { id:'photo', label:'Say Cheese',
        still:'/adult/assets/photo.webp?v=7', poster:'/adult/assets/photo-poster.webp?v=6', posterMobile:'/adult/assets/photo-poster-m.webp?v=7',
        clip:'/adult/assets/vid/photo.mp4?v=6', clipMobile:'/adult/assets/vid/photo-m.mp4?v=7',
