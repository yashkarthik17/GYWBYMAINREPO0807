  ...
  return {
    ...
    sections: [
      ...
      { id:'glowup', label:'The Crash',
        still:'/adult/assets/glowup.webp?v=8', poster:'/adult/assets/glowup-poster.webp?v=6', posterMobile:'/adult/assets/glowup-poster-m.webp?v=8',
        clip:'/adult/assets/vid/glowup.mp4?v=6', clipMobile:'/adult/assets/vid/glowup-m.mp4?v=8',
      ...
      { id:'photo', label:'Say Cheese',
        still:'/adult/assets/photo.webp?v=8', poster:'/adult/assets/photo-poster.webp?v=6', posterMobile:'/adult/assets/photo-poster-m.webp?v=8',
        clip:'/adult/assets/vid/photo.mp4?v=6', clipMobile:'/adult/assets/vid/photo-m.mp4?v=8',
